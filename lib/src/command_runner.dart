...
class ArchipelagoCliCommandRunner extends CompletionCommandRunner<int> {
  ...
  ArchipelagoCliCommandRunner({
    ...
    // Add sub commands
    addCommand(GenerateFeatureSkeletonCommand(logger: _logger));
    addCommand(GenerateLocalizationPackageCommand(logger: _logger));
    addCommand(GenerateUIKitCommand(logger: _logger));
    addCommand(InitializeMonorepoCommand(logger: _logger));
  ...
  Future<int> run(Iterable<String> args) async {
    try {
      ...
      final result = await runCommand(topLevelResults) ?? ExitCode.success.code;
      printFooter();
      return result;
